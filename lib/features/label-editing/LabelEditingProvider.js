...
export default function LabelEditingProvider(
  ...
  eventBus.on('directEditing.activate', function(event) {
    ...
    function onFocusout(focusEvent) {
      ...
      // Avoid redundant completion if the textbox is already detached.
      // Prevents "removeChild" NotFoundError during programmatic teardown.
      var content = directEditing._textbox && directEditing._textbox.content;
      ...
      if (!relatedTarget || !canvasContainer.contains(relatedTarget)) {
        ...
        // _textbox.destroy() internally would fire another focusout and
        // trigger a second complete() → double-destroy crash.
        completing = true;
        directEditing.complete();
        completing = false;
      }
